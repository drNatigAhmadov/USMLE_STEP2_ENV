...
exports.fetchMedQAQuestions = fetchMedQAQuestions;
exports.fetchMedQAByCategory = fetchMedQAByCategory;
exports.categorizeQuestion = categorizeQuestion;
exports.calculateDifficulty = calculateDifficulty;
const HF_DATASET = 'medqa';
const HF_SPLIT = 'train';
async function fetchMedQAQuestions(limit = 100, offset = 0) {
    try {
...
async function fetchMedQAByCategory(category, limit = 50) {
    try {
...
function calculateDifficulty(question) {
    ...
    hardIndicators.forEach(k => { if (text.includes(k))
        difficulty += 0.1; });
    easyIndicators.forEach(k => { if (text.includes(k))
        difficulty -= 0.05; });
